function z=fft_comparison_average_pulses_envelope(filename)
...
threshold=2.5/1000;     %ideally it should be 1mV but to exclude reflections 2.5mV makes more sense
                   ...
                   % (3/1000)
                    ...
                    if((index-last_index)/Fs>((300/1000)))
                        ...
                        if (alternate_colour_flag==1)
                            ...
                            plot(time_for_one_pulse, data_extracted(:,1,total_number_of_pulses),'k');
                        end
