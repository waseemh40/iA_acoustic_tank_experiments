function z=fft_comparison_filter_v2(filename,experiment_time)
%version 2
%It accepts time of experiment as argument.
close all;
    %raw data extraction
        ...
        if dataFilt(index) > (threshold)   
            ...
            if(lower_limit<0)
               index=index+3*pulse_length;
                ...
                data_extracted(1:pulse_length,1)=dataFilt(lower_limit:upper_limit);
